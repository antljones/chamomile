...
if object_id ('[repository_secure].[repository_secure.immutable.disallow_update_delete]'
              , 'TR') is not null
  drop trigger [repository_secure].[repository_secure.immutable.disallow_update_delete];
...
*/
create trigger [repository_secure].[repository_secure.immutable.disallow_update_delete]
...
if exists (select *
           from   fn_listextendedproperty(N'description'
                                          ...
                                          , N'immutable'
                                          , N'trigger'
                                          , N'repository_secure.immutable.disallow_update_delete'))
  exec sys.sp_dropextendedproperty
    ...
    @level2name = N'repository_secure.immutable.disallow_update_delete';
