...
if object_id ('[repository_secure].[repository_secure.immutable.disallow_overlapping_active_expire]'
              , 'TR') is not null
  drop trigger [repository_secure].[repository_secure.immutable.disallow_overlapping_active_expire];
...
*/
create trigger [repository_secure].[repository_secure.immutable.disallow_overlapping_active_expire]
on [repository_secure].[immutable]
after update, insert
as
  begin
...
if exists (select *
           from   fn_listextendedproperty(N'description'
                                          ...
                                          , N'immutable'
                                          , N'trigger'
                                          , N'repository_secure.immutable.disallow_overlapping_active_expire'))
  exec sys.sp_dropextendedproperty
    ...
    @level2name = N'repository_secure.immutable.disallow_overlapping_active_expire';
