...
if object_id(N'[repository_secure].[mutable]'
             , N'U') is not null
  drop table [repository_secure].[mutable];
...
*/
create table [repository_secure].[mutable]
  (
     [id]            [uniqueidentifier] not null constraint [repository_secure.mutable.id.default] default (newsequentialid()),
          constraint [repository_secure.mutable.id.primary_key_clustered] primary key clustered ([id])
     , [source]      [sysname] not null constraint [repository_secure.mutable.source.check] check ([source] in (N'metadata', N'report', N'log'))
     , [category]    [sysname]
     , [class]       [sysname]
     , [type]        [sysname]
     , [entry]       [xml] not null
     , [description] [nvarchar](max) null
     , [active]      [datetime] not null constraint [repository_secure.mutable.active.default] default current_timestamp
     , [expire]      [datetime] null
     , [created]     [datetime] not null constraint [repository_secure.mutable.created.default] default current_timestamp
  );
...
------------------------------------------------- 
------------------------------------------------- 
if indexproperty (object_id('[repository_secure].[mutable]')
                  , 'repository_secure.mutable.category.class.type.index'
                  , 'IndexID') is not null
  drop index [repository_secure.mutable.category.class.type.index] on [repository_secure].[mutable];

go

create nonclustered index [repository_secure.mutable.category.class.type.index]
  on [repository_secure].[mutable]([category], [class], [type]);
...
if exists (select *
           from   fn_listextendedproperty(N'description'
                                          ...
                                          , N'mutable'
                                          , N'index'
                                          , N'repository_secure.mutable.category.class.type.index'))
  exec sys.sp_dropextendedproperty
    ...
    @level2type = N'index',
    @level2name = N'repository_secure.mutable.category.class.type.index';

go

exec sys.sp_addextendedproperty
  @name = N'description',
  @value = N'create nonclustered index [repository_secure.mutable.category.class.type.index] 
  on [repository_secure].[mutable]([category], [class], [type]);',
  @level0type = N'schema',
  @level0name = N'repository_secure',
  @level1type = N'table',
...
------------------------------------------------- 
if indexproperty (object_id('[repository_secure].[mutable]')
                  , 'repository_secure.mutable.entry.index'
                  , 'IndexID') is not null
  drop index [repository_secure.mutable.entry.index] on [repository_secure].[mutable];

go

create primary xml index [repository_secure.mutable.entry.index]
  on [repository_secure].[mutable] ([entry]);
...
if exists (select *
           from   fn_listextendedproperty(N'description'
                                          ...
                                          , N'mutable'
                                          , N'index'
                                          , N'repository_secure.mutable.entry.index'))
  exec sys.sp_dropextendedproperty
    @name = N'description',
    @level0type = N'schema',
    @level0name = N'repository_secure',
    ...
    @level1name = N'mutable',
    @level2type = N'index',
    @level2name = N'repository_secure.mutable.entry.index';

go

exec sys.sp_addextendedproperty
  @name = N'description',
  @value = N'create primary xml index [repository_secure.mutable.entry.index] on [repository_secure].[mutable] ([entry]);',
  @level0type = N'schema',
  @level0name = N'repository_secure',
  @level1type = N'table',
  @level1name = N'mutable',
...
exec sys.sp_addextendedproperty
  @name = N'description',
  @value = N'The [repository_secure].[mutable] repository contains objects which must meet the business rules as defined in the 
